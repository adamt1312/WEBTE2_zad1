...
<head>
    ...
    <link rel="icon"
          type="image/png"
          href="https://i.ibb.co/Gv5MKpT/web-programming.png">
...
<div id="title_container">
    <h1 style="text-align: center; margin-bottom: 0 ">ZADANIE 1.</h1>
</div>
<div id="main_container" class="container-fluid">
    <div id="table_container" style="width: 600px">
    ...
    <div id="form_container">
        <form method="POST" action="upload.php" id="form" enctype="multipart/form-data">
            <div class="form-row">
                <div class="form-group" id="filename_container">
